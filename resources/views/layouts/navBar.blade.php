                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="post-block-style clearfix">
                                                <div class="post-thumb">
                                                    <a href="#"><img class="img-responsive"
                                                                     src="images/news/lifestyle/health2.jpg" alt=""></a>
                                                </div>
                                                <a class="post-cat" href="#">سلامتی</a>
                                                <div class="post-content">
                                                    <h2 class="post-title title-small">
                                        ...
                                        <div class="col-md-3">
                                            <div class="post-block-style clearfix">
                                                <div class="post-thumb">
                                                    <a href="#"><img class="img-responsive"
                                                                     src="images/news/lifestyle/health3.jpg" alt=""></a>
                                                </div>
                                                <a class="post-cat" href="#">سلامتی</a>
                                                <div class="post-content">
                                                    <h2 class="post-title title-small">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="post-block-style clearfix">
                                                <div class="post-thumb">
                                                    <a href="#"><img class="img-responsive"
                                                                     src="images/news/lifestyle/travel3.jpg" alt=""></a>
                                                </div>
                                                <a class="post-cat" href="#">مسافرت</a>
                                                <div class="post-content">
                                                    <h2 class="post-title title-small">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="post-block-style clearfix">
                                                <div class="post-thumb">
                                                    <a href="#"><img class="img-responsive"
                                                                     src="images/news/lifestyle/food1.jpg" alt=""></a>
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="post-block-style clearfix">
                                                <div class="post-thumb">
                                                    <a href="#"><img class="img-responsive"
                                                                     src="images/news/lifestyle/food2.jpg" alt=""></a>
                                                </div>
                                                <a class="post-cat" href="#">غذا</a>
                                                <div class="post-content">
                                                    <h2 class="post-title title-small">
                                        ...
                                        <div class="col-md-3">
                                            <div class="post-block-style clearfix">
                                                <div class="post-thumb">
                                                    <a href="#"><img class="img-responsive"
                                                                     src="images/news/lifestyle/food4.jpg" alt=""></a>
                                                </div>
                                                <a class="post-cat" href="#">غذا</a>
                                                <div class="post-content">
                                                    <h2 class="post-title title-small">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="single-post1.blade.php">طرح مطلب 1</a></li>
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="single-post1.blade.php">نوار کناری سمت چپ</a></li>
                        ...
                        <li class="dropdown-submenu active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="blockquote.blade.php">نقل قول ها</a></li>
                        ...
                        <li class="dropdown-submenu">
                            <a href="#.">صفحات</a>
                            <ul class="dropdown-menu">
                                <li><a href="author.blade.php">نویسنده</a></li>
